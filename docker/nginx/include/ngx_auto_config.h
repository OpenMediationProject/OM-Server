#define NGX_CONFIGURE " --prefix=/usr/local/nginx --with-http_stub_status_module --with-http_upstream_check_module --with-http_ssl_module"
...
#ifndef NGX_HAVE_PROC_STAT
#define NGX_HAVE_PROC_STAT  1
#endif
...
#define NGX_DSO_ABI_COMPATIBILITY  243878
#endif
...
#ifndef T_TENGINE_FIX
#define T_TENGINE_FIX  1
#endif
