...
public class PublisherAppBlockRule implements AppBlockRule {

    private PubAppPB.PublisherAppBlockRule rule;
    private Version osv_max, osv_min;

    public PublisherAppBlockRule(PubAppPB.PublisherAppBlockRule rule) {
        this.rule = rule;
